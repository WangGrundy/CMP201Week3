...
//	//further testing
//	ll->Insert('a');
//	std::cout << "expecting [a], got: " << ll->ToString();
//	ll->Reverse();
//	std::cout << "expecting [a], got: " << ll->ToString();
//	ll->Remove('a');
//	std::cout << "expecting [], got: " << ll->ToString();
//
//	ll->Insert('a');
//	ll->Insert('b');
//	std::cout << "expecting [a, b], got: " << ll->ToString();
//	ll->Reverse();
//	std::cout << "expecting [b, a], got: " << ll->ToString();
//	ll->Remove('a');
//	std::cout << "expecting [b], got: " << ll->ToString();
//
//	ll->Insert('a');
//	ll->Insert('b');
//	ll->Insert('c');
//	std::cout << "expecting [a, b, c], got: " << ll->ToString();
//	ll->Reverse();
//	std::cout << "expecting [c, b, a], got: " << ll->ToString();
//	ll->Remove('a');
//	std::cout << "expecting [c, b], got: " << ll->ToString();
//
//	///
//
//	ll->Insert(1);
//	std::cout << "expecting [1], got: " << ll->ToString();
//	ll->Reverse();
//	std::cout << "expecting [1], got: " << ll->ToString();
//	ll->Remove(1);
//	std::cout << "expecting [], got: " << ll->ToString();
...
//	ll->Insert(1);
//	ll->Insert(2);
//	std::cout << "expecting [1, 2], got: " << ll->ToString();
//	ll->Reverse();
//	std::cout << "expecting [2, 1], got: " << ll->ToString();
//	ll->Remove(1);
//	std::cout << "expecting [2], got: " << ll->ToString();
//
//	ll->Insert(1);
//	ll->Insert(2);
//	ll->Insert(3);
//	std::cout << "expecting [1, 2, 3], got: " << ll->ToString();
//	ll->Reverse();
//	std::cout << "expecting [3, 2, 1], got: " << ll->ToString();
//	ll->Remove(3);
//	std::cout << "expecting [2, 1], got: " << ll->ToString();
//}
